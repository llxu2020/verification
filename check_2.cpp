...
#define bsize 14      //The number of base codewords. 
#define subsize 5
#define vector_n  bsize
#define opsize 14     //The number of codewords. 
#define vector_m  11  //The length of code. 
#define charc 10000
...
int main(){
	...
	FILE *f = fopen ("11check.txt","r");	//File path.
	char tmp[charc];
	vector<int>  number;	
